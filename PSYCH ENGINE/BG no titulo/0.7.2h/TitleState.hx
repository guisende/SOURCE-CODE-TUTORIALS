...
import flixel.addons.display.FlxBackdrop; // - coisado
...
class TitleState extends MusicBeatState
{
	...
	var bgScroll:FlxBackdrop; // - coisado
	...
	function startIntro()
	{
		...
		bgScroll = new FlxBackdrop(Paths.image('nome da sua imagem'), 0, 0, true, false);
		bgScroll.velocity.set(100, 0);//também defina a velocidade tao rapida ou lenta quanto vocr quiser, apenas nao modifique o 0
		bgScroll.screenCenter(); 
		bgScroll.setGraphicSize(Std.int(bgScroll.width * 1.1));
		bgScroll.antialiasing = ClientPrefs.globalAntialiasing;
		credGroup.add(bgScroll);  //o tamanho é opcional minha imagem precisa ser maior se a sua não for então não faça isso
