...
class PlayState extends MusicBeatState
{
	...
	var blackthingup:FlxSprite;
	var blackthingdown:FlxSprite;

	var scorethingtext:FlxText;
	var missiesstext:FlxText;
	var rathingthingtext:FlxText;
	...
	override public function create()
	{
		...
		blackthingup = new FlxSprite(0, -78).loadGraphic(Paths.image("hudmomento/barraup"));
		blackthingup.cameras = [camHUD];
		blackthingup.scale.set(1.05, 1);
		add(blackthingup);

		blackthingdown = new FlxSprite(0, 10).loadGraphic(Paths.image("hudmomento/barradown"));
		blackthingdown.cameras = [camHUD];
		blackthingdown.scale.set(1.05, 1);
		add(blackthingdown);

		scorethingtext = new FlxText(40, 20, "", 28);
		scorethingtext.setFormat(Paths.font("chaotix.ttf"), 32, FlxColor.WHITE, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scorethingtext.cameras = [camHUD];
		add(scorethingtext);

		missiesstext = new FlxText(40, 70, "", 28);
		missiesstext.setFormat(Paths.font("chaotix.ttf"), 32, FlxColor.WHITE, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		missiesstext.cameras = [camHUD];
		add(missiesstext);

		rathingthingtext = new FlxText(900, 630, "", 28);
		rathingthingtext.setFormat(Paths.font("chaotix.ttf"), 32, FlxColor.WHITE, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		rathingthingtext.cameras = [camHUD];
		add(rathingthingtext);
	...
	override public function update(elapsed:Float)
	{
		...
		scorethingtext.text = 'SCORE: ' + songScore;
		missiesstext.text = 'MISSES: ' + songMisses;
		rathingthingtext.text = 'RATING: ' + ratingName + ' - ' + ratingFC;
